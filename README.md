...
1. It downloads and reads the data
2. It merges the training and the test sets to create one data set
3. It extracts the mean and standard deviation for each measurement
4. It creates a tidy data set with the average of each variable for each activity and each subject
